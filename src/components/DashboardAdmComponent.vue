<template>
  <div class="dashboard-container p-5">
    <DashboardCardContainer icono="bi bi-list-columns-reverse" nombre="Productos Activos" :cantidad="cantProduct"/>
    <DashboardCardContainer icono="bi bi-people-fill" nombre="Usuarios Activos" :cantidad="cantUsuarios"/>
    <DashboardCardContainer icono="bi bi-cart-check-fill" nombre="Ordenes realizadas" :cantidad="cantOrdenes"/>
  </div>
</template>
