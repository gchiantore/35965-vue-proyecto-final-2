<template>
  ...
  <script>
      ...
      export default {
          ...
          beforeUpdate(){
            if(this.veces!=1 && !this.formulario){
                const URLAPIPRODUCTOS="https://639e8f4e3542a261305d989b.mockapi.io/productos";
                    axios.get(URLAPIPRODUCTOS)
                        .then(response => response.data)
                        .then(data =>{
                            ...
                            this.veces=1
                            console.log('en el before dentro del coclo'+this.veces)
                    })  
            }    
          },
          methods:{
            ...
            eliminarProducto(id){
                this.$swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const URLDELETE="https://639e8f4e3542a261305d989b.mockapi.io/productos/"+id
